class Chessboard:
 ...
 # Do do: Enpasent, Casteln, Queeen reparieren
    def __init__(self):
        self.board = [
    ...
    def check_pos_moves(self, pos):
        ...
        if piece_num == 0: # moves für keine Figur
            ...
            if self.is_black(self.return_figur(pos - 9)): # checkt Feld rechts vorne auf Gegner
                ret.append((pos - 9))

            if self.is_black(self.return_figur(pos - 11)): # checkt Feld links vorne auf Gegner
                ret.append((pos - 11))
            ...
            for i in [-11, -9, 9, 11]:
                ...
                while self.return_figur(new_pos) == 0:
                    ret.append(new_pos)
                    new_pos += i
                if self.isnt_samecolor(self.return_figur(pos), self.return_figur(new_pos)):
                    ret.append(new_pos)
            ...
            for i in [1,9,10,11,-11,-10,-9,-1]:
                new_pos = pos + i
                if self.return_figur(new_pos) == 0 or self.isnt_samecolor(self.return_figur(pos),self.return_figur(new_pos)):
                    ret.append(new_pos)
            ...
            if self.white_king_moved: #rocharde
                if self.white_rrook_moved and self.return_figur(76) + self.return_figur(77) == 0:
                    ret.append(78)
                if self.white_lrook_moved and self.return_figur(74) + self.return_figur(73) + self.return_figur(72) == 0:
                    ret.append(71)
